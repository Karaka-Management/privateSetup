...
<html lang="en">
    <head>
        <title>Jingga - Dev</title>
        <?php include __DIR__ . '/head.tpl.php'; ?>
        <link rel="stylesheet" href="Web/{APPNAME}/css/dev.css">
    </head>
    <body>
        <header>
        ...
        <main>
            ...
            <div class="block block3">
                <div class="floater">
                    ...
                    <div class="flex">
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_creative_process_q6aw.svg" width="43%"></div>
                            <h1>phpOMS</h1>
                            <h2>Tests</h2>
                            <ul>
                        ...
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_design_feedback_dexe.svg" width="70%"></div>
                            <h1>jsOMS</h1>
                        ...
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_wireframing_nxyi.svg" width="53%"></div>
                            <h1>Application</h1>
                            <h2>Tests</h2>
                            <ul>
                                <li><a href="Inspection/Test/Php/phpunit.log">PhpUnit</a>
                            ...
                            <ul>
                                ...
                                <li><a href="https://github.com/karaka-management/Jingga/issues">Issues</a>
                            </ul>
                        </div>
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_product_teardown_elol.svg" width="43%"></div>
                            <h1>Modules</h1>
                            <h2>Tests</h2>
                            <ul>
                                <li><a href="Inspection/Test/Php/phpunit.log">PhpUnit</a>
                        ...
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_innovative_b409.svg" width="50%"></div>
                            <h1>cssOMS</h1>
                            <p>Not yet implemented</p>
                            <h2>Other</h2>
                            <ul>
                        ...
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_folder_39kl.svg" width="43%"></div>
                            <h1>Documentation</h1>
                            <p>Not yet implemented</p>
                            <h2>Other</h2>
                            <ul>
                        ...
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_code_review_l1q9.svg" width="48%"></div>
                            <h1>Developer-Guide</h1>
                            <p>Not yet implemented</p>
                            <h2>Other</h2>
                            <ul>
                        ...
                        <div class="box1 box">
                            <div class="tcenter"><img src="Web/{APPNAME}/img/undraw_version_control_9bpv.svg" width="55%"></div>
                            <h1>Build</h1>
                            <p>Not yet implemented</p>
                            <h2>Other</h2>
                            <ul>
