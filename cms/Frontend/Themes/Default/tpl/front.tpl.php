            ...
            <div class="floater">
                <div id="header-content">
                    <span class="box slide-up-fade-in">
                        ...
                        <p>Modern business software in one application for all company sizes and types. The Jingga software supports you with your tasks and relieves you from as much administrative work as possible so you can focus on the important aspects of your business.</p>
                    </span>
                    <span class="img"><img alt="logo" src="Web/{APPNAME}/img/logo.png"></span>
                </div>
            </div>
        </header>
        <main>
            <div class="block block1">
                <div id="content-header-container">
                    <div class="floater">
                        <div class="flex">
                            <div class="box1 box">
                                <div class="tcenter"><img alt="calendar" loading="lazy" src="Web/{APPNAME}/img/undraw_calendar_dutt.svg" width="60%"></div>
                                <h1>Manage your Business</h1>
                                <p>Jingga provides all the tools you need in order to manage your business and handle it's activities in one eco-system. You and your team will be able to focus on the important things allowing your business to grow.</p>
                            </div>
                            <div class="box1 box">
                                <div class="tcenter"><img alt="devices" loading="lazy" src="Web/{APPNAME}/img/undraw_progressive_app_m9ms.svg" width="82%"></div>
                                <h1>Unlock all Platforms</h1>
                                <p>Use the Jingga application from every platform from every place. You can collaborate with your team, no matter if you use cellphone, tablet or PC and have full control over everything.</p>
                                <p></p>
                            </div>
                            <div class="box1 box">
                                <div class="tcenter"><img alt="report" loading="lazy" src="Web/{APPNAME}/img/undraw_visual_data_b1wx.svg" width="67%"></div>
                                <h1>Comprehensive Insights</h1>
                                <p>Gain full insights about every aspect of your business in easy to understand reports and analysis. Let Jingga help you with improving your workflows and business operations.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="block1-b">
                    <div class="floater">
                        ...
                        <h2>The key to a successful business is the amount of time you can efficiently focus on your core business operations and how well a software can support you with these tasks. Jingga provides you with the following benefits:</h2>
                        <div class="flex section">
                            ...
                            <div class="box center">
                                    <img alt="grow" width="90%" loading="lazy" src="Web/{APPNAME}/img/undraw_completed_ngx6.svg">
                            </div>
                            <div class="box right">
                                <div class="flex">
                                    <div class="text">
            ...
            <div class="block block2">
                <div class="floater">
                    ...
                    <div class="flex section">
                        ...
                        <div class="box1">
                            <div class="tcenter"><img alt="cloud" loading="lazy" src="Web/{APPNAME}/img/undraw_app_installation_mbdv.svg" width="45%"></div>
                            <h1>Installation</h1>
                        ...
                        <div class="box1">
                            <div class="tcenter"><img alt="books" loading="lazy" src="Web/{APPNAME}/img/undraw_files1_9ool.svg" width="40%"></div>
                            <h1>Documentation</h1>
                        ...
                        <div class="box1">
                            <div class="tcenter"><img alt="workflow" loading="lazy" src="Web/{APPNAME}/img/undraw_solution_mindset_34bi.svg" width="55%"></div>
                            <h1>Modules</h1>
