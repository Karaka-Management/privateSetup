<div class="front-block">
    <div class="front-block-img"><img alt="Tracking" src="Web/Orw/img/undraw_sync_files_re_ws4c.svg"></div>
    <div class="front-block-text">
        <h1>Track online changes</h1>
        <div class="front-block-body">
            The Orw allows you to automatically keep track of online changes to websites, PDFs, Word files, images and much more saving you from manually checking those. You can use this service to stay up-to-date with publications on websites, monitor changes to laws and regulations published online, online product updates and more.
        </div>
    </div>
</div>

<div class="front-block">
    <div class="front-block-img"><img alt="Notification" src="Web/Orw/img/undraw_envelope_re_f5j4.svg"></div>
    <div class="front-block-text">
...
<div class="front-block">
    <div class="front-block-img"><img alt="Comparison" src="Web/Orw/img/undraw_split_testing_l1uw.svg"></div>
    <div class="front-block-text">
...
<div class="front-block">
    <div class="front-block-img"><img alt="Teams" src="Web/Orw/img/undraw_team_up_re_84ok.svg"></div>
    <div class="front-block-text">
...
<div class="front-block">
    <div class="front-block-img"><img alt="Teams" src="Web/Orw/img/undraw_cloud_files_wmo8.svg"></div>
    <div class="front-block-text">
        <h1>Web vs. Local</h1>
        <div class="front-block-body">
